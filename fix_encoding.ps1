...
function Fix-File($path, $pairs) {
  ...
  if (-not (Test-Path $fullPath)) { Write-Host "SKIP $path"; return }
...
Fix-File 'src\views\supplier\MyInventory.vue' @(
  '供应�?- 我的库存', '供应商 - 我的库存',
  '自动占�?>', '自动占用</PageWrapper>',
...
Fix-File 'src\views\supplier\MySettlement.vue' @(
  '供应�?- 我的结算', '供应商 - 我的结算',
  '等待付�?>', '等待付款</PageWrapper>',
  '待确认应�?/div>', '待确认应收</div>',
  '累计已到�?/div>', '累计已到账</div>',
...
Fix-File 'src\views\supplier\ProductLibrary.vue' @(
  '供应�?- 自营商品库', '供应商 - 自营商品库',
  '创建报�?>', '创建报价</PageWrapper>',
  '默认成本�?, width: 120', '默认成本价'', width: 120'
)

Fix-File 'src\views\supplier\ShipmentManage.vue' @(
  '供应�?- 发货管理', '供应商 - 发货管理',
...
Fix-File 'src\views\supplier\Profile.vue' @(
...
Fix-File 'src\views\supplier\OrderPending.vue' @(
  '供应�?- 待确认集采单', '供应商 - 待确认集采单',
  '确认或拒�?>', '确认或拒绝</PageWrapper>',
...
Fix-File 'src\views\supplier\OrderActive.vue' @(
...
Fix-File 'src\views\supplier\QuoteManage.vue' @(
  '供应�?- 报价管理', '供应商 - 报价管理',
  '平台审核�?>', '平台审核）</PageWrapper>',
  '起订�?, width: 80', '起订量'', width: 80',
  '单位'' }}�?<span', '单位'' }}）<span'
)

Fix-File 'src\views\supplier\QuoteHistory.vue' @(
  '供应�?- 报价历史', '供应商 - 报价历史'
)

# Store views
Fix-File 'src\views\store\Cart.vue' @(
  '购�?/Badge>', '购物车</Badge>',
  '空空如�?      <div', '空空如也',
  '全�?/span>', '全选</span>',
  '结算�?-->', '结算栏 -->'
...
Fix-File 'src\views\store\OrderDetail.vue' @(
  '加载�?..</div>', '加载中...</div>',
  '无访问权�?/div>', '无访问权限</div>',
  '收货 / 时间�?-->', '收货 / 时间线 -->',
  '时间�?-->', '时间线 -->',
...
Fix-File 'src\views\store\Procurement.vue' @(
  '销售价�?>', '销售价）',
  '加载�?..</div>', '加载中...</div>',
...
Fix-File 'src\views\store\MyOrders.vue' @(
  'SKU �?, width: 80', 'SKU 数'', width: 80',
  '承运�?, width: 110', '承运方'', width: 110',
  '运单�?, width: 160', '运单号'', width: 160',
...
Fix-File 'src\views\store\MyPayments.vue' @(
  '订单�名 class=', '订单号" class=',
  '流水�?/span>', '流水号：</span>',
  '凭证�?/div>', '凭证图</div>'
)

Fix-File 'src\views\store\SalesReport.vue' @(
  '销�?, width: 100', '销量'', width: 100'
)

Fix-File 'src\views\store\Profile.vue' @(
  '保存�?..', '保存中...',
  '加载�?..</div>', '加载中...</div>',
...
# Admin views
Fix-File 'src\views\admin\CatalogManage.vue' @(
  '平台管理�?- 平台商品目录', '平台管理员 - 平台商品目录',
  '可�名 />', '可选" />'
)

Fix-File 'src\views\admin\PaymentManage.vue' @(
  '平台管理�?- 待确认收�? */', '平台管理员 - 待确认收款 */',
  '关联订单�?, width: 160', '关联订单号'', width: 160',
  '支付记�?>', '支付记录</PageWrapper>',
...
Fix-File 'src\views\admin\StockManage.vue' @(
...
Fix-File 'src\views\admin\QuoteReview.vue' @(
...
Fix-File 'src\views\admin\ProfitRecords.vue' @(
...
Fix-File 'src\views\admin\SettlementStores.vue' @(
  '平台管理�?- 门店结算（应收）', '平台管理员 - 门店结算（应收）',
  '订单�?, width: 90', '订单数'', width: 90',
  '结算�?>', '结算单</PageWrapper>'
)

Fix-File 'src\views\admin\SettlementSuppliers.vue' @(
  '平台管理�?- 供应商结算（应付�? */', '平台管理员 - 供应商结算（应付） */',
  '供应�?, minWidth: 200', '供应商'', minWidth: 200',
  '供应�名 class=', '供应商" class='
)

Fix-File 'src\views\admin\StoreOrderManage.vue' @(
...
Fix-File 'src\views\admin\StoreReview.vue' @(
  '平台管理�?- 门店入驻审核', '平台管理员 - 门店入驻审核',
  '负责�?, width: 100', '负责人'', width: 100',
  '入驻申�?>', '入驻申请</PageWrapper>',
  '申请编号�?/span>', '申请编号：</span>',
  '门店名称�?/span>', '门店名称：</span>',
  '门店类型�?/span>', '门店类型：</span>',
  '电话�?/span>', '电话：</span>',
...
Fix-File 'src\views\admin\SupplierReview.vue' @(
