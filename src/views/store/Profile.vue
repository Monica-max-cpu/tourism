...
import { Save, Building2, MapPin } from 'lucide-vue-next';
import {
...
<template>
  <PageWrapper title="门店资料" subtitle="维护门店基本信息与默认收货地址">
    <template #extra>
      <Badge variant="secondary">最后更新：{{ form.updatedAt ? formatDateTime(form.updatedAt) : '-' }}</Badge>
      ...
      <Card>
        <CardContent class="p-5 space-y-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="space-y-1.5 col-span-2">
              <Label>门店简介</Label>
              <Input v-model="form.description" placeholder="商圈位置、客流情况等" />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent class="p-5 space-y-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="space-y-1.5 col-span-2">
              <Label>收货地址</Label>
              <Input v-model="form.receiveAddress" placeholder="xx 省 xx 市 xx 区" />
            </div>
          </div>
        </CardContent>
      </Card>
