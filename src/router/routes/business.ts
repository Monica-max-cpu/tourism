...
export const supplierRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    { path: 'orders/:id', name: 'SupplierOrderDetail', component: () => import('/@/views/admin/CollectiveDetail.vue'), meta: { title: '集采单详情', hideInMenu: true, authCode: 'b2b:collective:detail' } },
