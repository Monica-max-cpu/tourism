...
export const adminRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    { path: 'catalog/create', name: 'AdminCatalogCreate', component: () => import('/@/views/admin/CatalogForm.vue'), meta: { title: '新建目录商品', hideInMenu: true, authCode: 'b2b:catalog:edit' } },
    { path: 'catalog/:id/edit', name: 'AdminCatalogEdit', component: () => import('/@/views/admin/CatalogForm.vue'), meta: { title: '编辑目录商品', hideInMenu: true, authCode: 'b2b:catalog:edit' } },
    { path: 'stocks', name: 'AdminStocks', component: () => import('/@/views/admin/StockManage.vue'), meta: { title: '库存列表' } },
    { path: 'stocks/log', name: 'AdminStockLogs', component: () => import('/@/views/admin/StockLog.vue'), meta: { title: '库存流水' } },
    { path: 'store-orders', name: 'AdminStoreOrders', component: () => import('/@/views/admin/StoreOrderManage.vue'), meta: { title: '门店采购订单' } },
    { path: 'store-orders/:id', name: 'AdminStoreOrderDetail', component: () => import('/@/views/admin/StoreOrderDetail.vue'), meta: { title: '订单详情', hideInMenu: true } },
    { path: 'payments', name: 'AdminPayments', component: () => import('/@/views/admin/PaymentManage.vue'), meta: { title: '支付记录', authCode: 'b2b:payment:list' } },
    { path: 'credit/accounts', name: 'AdminCreditAccounts', component: () => import('/@/views/admin/CreditAccounts.vue'), meta: { title: '授信账户管理', authCode: 'b2b:credit:accountList' } },
    { path: 'credit/bills', name: 'AdminCreditBills', component: () => import('/@/views/admin/CreditBills.vue'), meta: { title: '授信账单查看', authCode: 'b2b:credit:billList' } },
    { path: 'payment/splits', name: 'AdminPaymentSplits', component: () => import('/@/views/admin/CreditSplits.vue'), meta: { title: '支付分账管理', authCode: 'b2b:paymentSplit:list' } },
    ...
    { path: 'collective/orders/:id', name: 'AdminCollectiveDetail', component: () => import('/@/views/admin/CollectiveDetail.vue'), meta: { title: '集采单详情', hideInMenu: true, authCode: 'b2b:collective:detail' } },
    ...
    { path: 'deliveries/:id', name: 'AdminDeliveryDetail', component: () => import('/@/views/delivery/DeliveryDetail.vue'), meta: { title: '发货单详情', hideInMenu: true, authCode: 'b2b:delivery:detail' } },
    { path: 'settlements/stores', name: 'AdminSettlementsStores', component: () => import('/@/views/admin/SettlementStores.vue'), meta: { title: '门店结算', authCode: 'b2b:settlement:storeList' } },
    { path: 'settlements/suppliers', name: 'AdminSettlementsSuppliers', component: () => import('/@/views/admin/SettlementSuppliers.vue'), meta: { title: '供应商结算', authCode: 'b2b:settlement:supplierList' } },
    { path: 'profits', name: 'AdminProfits', component: () => import('/@/views/admin/ProfitRecords.vue'), meta: { title: '利润记录', authCode: 'b2b:settlement:profitList' } },
...
export const supplierRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    { path: 'quote/create', name: 'SupplierQuoteCreate', component: () => import('/@/views/supplier/QuoteForm.vue'), meta: { title: '新建报价', hideInMenu: true, authCode: 'b2b:supplier:quote' } },
    { path: 'quote/:id/edit', name: 'SupplierQuoteEdit', component: () => import('/@/views/supplier/QuoteForm.vue'), meta: { title: '编辑报价', hideInMenu: true, authCode: 'b2b:supplier:quote' } },
    ...
    // 进行中集采单已合并到待确认集采单页面，通过状态筛选和操作列区分。
    // { path: 'orders/active', name: 'SupplierOrderActive', component: () => import('/@/views/supplier/OrderActive.vue'), meta: { title: '进行中集采单' } },
    { path: 'orders/:id', name: 'SupplierOrderDetail', component: () => import('/@/views/supplier/CollectiveDetail.vue'), meta: { title: '集采单详情', hideInMenu: true, authCode: 'b2b:collective:detail' } },
    ...
    { path: 'shipments/:id', name: 'SupplierShipmentDetail', component: () => import('/@/views/delivery/DeliveryDetail.vue'), meta: { title: '发货单详情', hideInMenu: true, authCode: 'b2b:supplier:delivery' } },
...
export const storeRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    { path: 'credit', name: 'StoreCredit', component: () => import('/@/views/store/CreditAccount.vue'), meta: { title: '授信账户', icon: 'Wallet', authCode: 'b2b:credit:account' } },
