...
// update-begin--author:claude---date:2026-05-24---for:【B2B-阶段3】供应商端 9 模块路由替换
...
// update-end--author:claude---date:2026-05-24---for:【B2B-阶段3】供应商端 9 模块路由替换
...
export const storeRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    { path: 'sales', name: 'StoreSales', component: () => import('/@/views/store/SalesReport.vue'), meta: { title: '销售上报', authCode: 'b2b:store:sales' } },
